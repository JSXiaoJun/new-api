...
type Pricing struct {
	...
	PeakPricing            *billing_setting.PeakPricing `json:"peak_pricing,omitempty"`
...
func updatePricing() {
	...
	for model, groups := range modelGroupsMap {
		...
		if peak, ok := billing_setting.GetPeakPricing(model); ok {
			pricing.PeakPricing = &peak
			pricing.BillingMode = billing_setting.BillingModePeak
			billingMode = billing_setting.BillingModePeak
		}
