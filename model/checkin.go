...
// UserCheckin 执行用户签到
// The record and wallet credit share one transaction on every database.
func UserCheckin(userId int) (*Checkin, error) {
	...
	// All supported databases can commit the check-in and wallet atomically.
	return userCheckinWithTransaction(checkin, userId, quotaAwarded)
}

// userCheckinWithTransaction commits the check-in and its wallet credit together.
...
// Retained for callers of the former SQLite-specific path.
