...
func newChannelAffinityStatsIdentity(t *testing.T) (string, string) {
	t.Helper()
	sequence := channelAffinityUsageTestSequence.Add(1)
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := newChannelAffinityStatsIdentity(t)
	usingGroup := "default"
