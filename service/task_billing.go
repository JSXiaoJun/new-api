...
// IsTaskPerSecondBilling identifies task models whose fixed model price is the
// price of one generated second. The task adaptor supplies the duration as the
