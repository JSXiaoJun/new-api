...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.GET("/after-sales", middleware.UserAuth(), controller.GetAfterSales)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			adminRoute.Use(middleware.AdminAuth())
			{
				...
				adminRoute.GET("/:id/quota/log", controller.GetUserQuotaLogs)
		...
		logRoute.GET("/response_body", middleware.RootAuth(), controller.GetLogResponseBody)
